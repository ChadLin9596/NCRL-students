...
void pos_cb(const gazebo_msgs::ModelStates.pose::ConstPtr& msg)
{
  pose = *msg;
}
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber pos_sub = n.subscribe<gazebo_msgs::ModelStates.pose>("/gazebo/model_states ", 10, pos_cb);
